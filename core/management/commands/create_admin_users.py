...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('Super Admin: superadmin.test@demo.com / complexpass123')
        )
        self.stdout.write(
            self.style.SUCCESS('Security Admin: securityadmin@ssdm.com / secure_password_456')
        )
        self.stdout.write(
            self.style.SUCCESS('Admin: admin@ssdm.com / admin_password_789')
        )
